...
import com.ant.vxserver.sdk.api.PaymentApi;
import com.ant.vxserver.sdk.api.PaymentApi.TradeType;
import com.ant.vxserver.sdk.kit.PaymentKit;
import com.ant.vxserver.sdk.utils.PaymentException;
...
public class WxaPayApi {
     ...
     * @return Map
     */
    public Map<String, String> unifiedOrder(com.ant.vxserver.wxaapp.api.WxaOrder order) throws PaymentException {
